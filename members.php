...
<div class="space-y-6">
    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <form method="POST" action="actions.php" enctype="multipart/form-data" class="p-5 space-y-4 text-xs">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div>
                            ...
                            <input type="date" name="dob" required class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 focus:ring-1 focus:ring-emerald-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block font-semibold text-slate-600 mb-1">Gender *</label>
                            <select name="gender" required class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 focus:ring-1 focus:ring-emerald-500 focus:outline-none">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" required placeholder="Phone" class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 focus:ring-1 focus:ring-emerald-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block font-semibold text-slate-600 mb-1">Blood Group</label>
                            <select name="blood_group" class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 focus:ring-1 focus:ring-emerald-500 focus:outline-none">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <div id="form-deceased-date-container" class="hidden">
                            ...
                            <input type="date" name="deceased_date" id="form-deceased-date-field" class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 focus:ring-1 focus:ring-emerald-500 focus:outline-none">
                        </div>
                    </div>
        ...
        <div class="relative mb-6">
            ...
            <input type="text" id="search-member" onkeyup="filterMembers()" placeholder="Search members by First Name, Last Name, Family Card No, Phone..." class="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-3 text-xs focus:ring-2 focus:ring-emerald-500 focus:bg-white focus:outline-none transition-all">
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50 border-b border-slate-200 text-slate-500 text-xs font-semibold uppercase tracking-wider">
