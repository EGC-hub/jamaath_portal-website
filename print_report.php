...
try {
    if ($type === 'inflows') {
        $reportTitle = "Contribution Inflows (Collections) Audit Sheet";
...
if ($format === 'excel') {
    ...
    echo "<th>Line Reference Participant</th>";
    echo "<th>Category Type</th>";
    echo "<th>Registry Timestamp</th>";
    echo "<th>Transaction Value (₹)</th>";
    echo "</tr>";
    ...
    echo "<td colspan='3' style='text-align: right;'>Final Calculated Aggregate Statement Total:</td>";
...
<head>
    <meta charset="UTF-8">
    <title>Bait-ul-Mal Financial Audit Statement</title>
    ...
    <div
        ...
        <div class="border-b-2 border-slate-900 pb-5 mb-6 flex justify-between items-end">
            ...
            <div class="text-right text-xs text-slate-400 font-medium">
                ...
                <div class="font-mono text-[10px] mt-0.5">Audit generated by:
                ...
                <table class="w-full text-left border-collapse text-xs">
                    <thead>
                        <tr
                            ...
                            <th class="py-3 px-4">Line Reference Participant</th>
                            <th class="py-3 px-4">Category Type</th>
                            <th class="py-3 px-4 font-mono">Registry Timestamp</th>
                            <th class="py-3 px-4 text-right">Transaction Value</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100 font-medium text-slate-700">
                        ...
                        <tr class="bg-slate-50 font-bold border-t-2 border-slate-200 print:bg-transparent">
                            <td colspan="3"
                                ...
                                Final Calculated Aggregate Statement Total:</td>
                            <td
