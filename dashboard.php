        ...
        <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <p class="text-xs text-slate-500">Quick administrative gateway to all active management portals and
                        live registries</p>
                </div>
                <span class="text-xs bg-teal-50 px-2.5 py-1 rounded-lg text-teal-700 font-bold">System Status:
                    Active</span>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                ...
                <a href="members.php"
                    ...
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Members</p>
                ...
                <a href="burial.php"
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400 font-medium">Graveyard Maps</p>
                    </div>
                </a>
                ...
                <a href="manage_gallery.php"
                    ...
                    <div
                        class="w-9 h-9 rounded-lg bg-white text-slate-500 group-hover:text-emerald-700 shadow-sm border border-slate-100 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-images text-sm"></i></div>
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Web CMS</p>
                        <p class="text-[10px] text-slate-400 font-medium">Public Gallery</p>
                    </div>
                </a>

                <!-- Custom Added Functional Placeholders linking to your unassigned controller -->
                <a href="unassigned.php?feature=Academy"
                    class="p-3.5 bg-slate-50 hover:bg-emerald-50 border border-slate-100 hover:border-emerald-200 rounded-xl transition-all duration-200 group flex items-center space-x-3">
                    <div
                        class="w-9 h-9 rounded-lg bg-white text-slate-500 group-hover:text-emerald-700 shadow-sm border border-slate-100 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-graduation-cap text-sm"></i></div>
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Academy</p>
                        <p class="text-[10px] text-slate-400 font-medium">Seminars & Class</p>
                    </div>
                </a>
                ...
                <a href="unassigned.php?feature=Income+and+Expenses"
                    ...
                    <div
                        class="w-9 h-9 rounded-lg bg-white text-slate-500 group-hover:text-emerald-700 shadow-sm border border-slate-100 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-money-bill-transfer text-sm"></i></div>
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Finance</p>
                        <p class="text-[10px] text-slate-400 font-medium">Income/Expense</p>
                    </div>
                </a>
                ...
                <a href="unassigned.php?feature=Arabic+School"
                    ...
                    <div
                        class="w-9 h-9 rounded-lg bg-white text-slate-500 group-hover:text-emerald-700 shadow-sm border border-slate-100 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-book-quran text-sm"></i></div>
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Madrasa</p>
                        <p class="text-[10px] text-slate-400 font-medium">Arabic School</p>
                    </div>
                </a>
                ...
                <a href="unassigned.php?feature=Employee+Salary"
                    ...
                    <div
                        class="w-9 h-9 rounded-lg bg-white text-slate-500 group-hover:text-emerald-700 shadow-sm border border-slate-100 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-wallet text-sm"></i></div>
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Payroll</p>
                        <p class="text-[10px] text-slate-400 font-medium">Staff Salaries</p>
                    </div>
                </a>
                ...
                <a href="unassigned.php?feature=Transportation"
                    ...
                    <div
                        class="w-9 h-9 rounded-lg bg-white text-slate-500 group-hover:text-emerald-700 shadow-sm border border-slate-100 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-bus text-sm"></i></div>
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Transport</p>
                        <p class="text-[10px] text-slate-400 font-medium">Vehicle Logs</p>
                    </div>
                </a>
                ...
                <a href="unassigned.php?feature=Property+Register"
                    ...
                    <div
                        class="w-9 h-9 rounded-lg bg-white text-slate-500 group-hover:text-emerald-700 shadow-sm border border-slate-100 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-building-shield text-sm"></i></div>
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Property</p>
                        <p class="text-[10px] text-slate-400 font-medium">Asset Register</p>
                    </div>
                </a>
                ...
                <a href="unassigned.php?feature=Backup+and+Restore"
                    ...
                    <div
                        class="w-9 h-9 rounded-lg bg-white text-slate-500 group-hover:text-emerald-700 shadow-sm border border-slate-100 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-database text-sm"></i></div>
                    <div>
                        <p class="font-bold text-slate-800 text-xs group-hover:text-emerald-950">Maintenance</p>
                        <p class="text-[10px] text-slate-400 font-medium">Backup/Restore</p>
                    </div>
                </a>
