...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-br from-teal-900 to-emerald-950 text-white p-6 rounded-2xl shadow-md relative overflow-hidden">
            ...
            <p class="text-xs text-emerald-200 leading-relaxed mb-4">Official administrative portal governing demographic registrations, Baitul-Mal support initiatives, Nikah certifications, and cemetery plots inside Nagercoil.</p>
