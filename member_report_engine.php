    ...
    <div
        ...
        <div class="border-b-2 border-slate-900 pb-5 mb-6 flex justify-between items-end">
            <div>
                ...
                <p class="text-xs font-bold text-teal-800 mt-0.5 uppercase tracking-wider">Report of jamaath members</p>
            </div>
            <div class="text-right text-xs text-slate-400 font-medium">
                <div>Generated On: <?php echo date('d M Y - h:i A'); ?></div>
                ...
                <table class="w-full text-left border-collapse text-xs">
                    <thead>
                        <tr
                            ...
                            <th class="py-3 px-4 text-center">Chanda Status</th>
                        </tr>
                    </thead>
