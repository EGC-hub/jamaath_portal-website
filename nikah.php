            ...
            <tbody id="nikah-table-rows" class="divide-y divide-slate-100 text-xs">
                ...
                <?php else: ?>
                    <?php foreach ($nikah_list as $nikah): ?>
                        <tr onclick='openNikahCard(<?php echo json_encode($nikah); ?>)'
...
<div id="nikah-modal"
    ...
    <div
        ...
        <div class="flex justify-between items-center mb-2">
            ...
            <button onclick="closeNikahModal()" class="text-slate-400 hover:text-slate-600 transition-colors"><i
                    class="fa-solid fa-circle-xmark text-lg"></i></button>
        </div>
        <p class="text-xs text-slate-500 mb-4">Validate demographics, age boundaries, and marital status of both
            partners.</p>
        ...
        <form id="nikah-form" method="POST" action="actions.php" class="space-y-4 text-xs">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
                    <h5 class="font-bold text-teal-900 text-xs flex items-center gap-1.5"><i
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-1 cursor-pointer">
                                <input type="radio" id="groom_origin_external" name="groom_origin" value="external"
                                    onchange="toggleGroomFields()" class="text-teal-600 focus:ring-teal-500"> Outside
                                Jamaath
                            </label>
                        </div>
                    </div>
                    ...
                    <div id="groom_jamath_container" class="space-y-2">
                        ...
                        <select id="groom_select" name="groom_member_id" onchange="autoPopulateGroom()"
                            ...
                            <?php foreach ($eligible_grooms as $idx => $g): ?>
                                <option value="<?php echo $idx; ?>" data-name="<?php echo htmlspecialchars($g['name']); ?>"
                                    data-father="<?php echo htmlspecialchars($g['father']); ?>"
                                    data-age="<?php echo $g['age']; ?>"
                                    data-source="<?php echo htmlspecialchars($g['source']); ?>">
                                    <?php echo htmlspecialchars($g['name']); ?> (Age: <?php echo $g['age']; ?> |
                                    <?php echo htmlspecialchars($g['source']); ?>)
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="space-y-2">
                        <div>
                            <label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Groom Name
                                *</label>
                            <input type="text" id="groom_name_field" name="groom_name" required placeholder="Groom Name"
                                class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-xs focus:ring-1 focus:ring-teal-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Father's Name
                                *</label>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                <label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Groom Age
                                    *</label>
                                <input type="number" id="groom_age_field" name="groom_age" required min="21"
                                    placeholder="Age"
                                    class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-xs focus:ring-1 focus:ring-teal-500 focus:outline-none">
                                <p class="text-[9px] text-slate-400 mt-0.5">Min legal age is 21</p>
                            </div>
                            <div>
                                <label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Marriage Status
                                    *</label>
                ...
                <!-- Bride Section -->
                <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
                    <h5 class="font-bold text-pink-900 text-xs flex items-center gap-1.5"><i
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-1 cursor-pointer">
                                <input type="radio" id="bride_origin_external" name="bride_origin" value="external"
                                    onchange="toggleBrideFields()" class="text-teal-600 focus:ring-teal-500"> Outside
                                Jamaath
                            </label>
                        </div>
                    </div>
                    ...
                    <div id="bride_jamath_container" class="space-y-2">
                        ...
                        <select id="bride_select" name="bride_member_id" onchange="autoPopulateBride()"
                            ...
                            <?php foreach ($eligible_brides as $idx => $b): ?>
                                <option value="<?php echo $idx; ?>" data-name="<?php echo htmlspecialchars($b['name']); ?>"
                                    data-father="<?php echo htmlspecialchars($b['father']); ?>"
                                    data-age="<?php echo $b['age']; ?>"
                                    data-source="<?php echo htmlspecialchars($b['source']); ?>">
                                    <?php echo htmlspecialchars($b['name']); ?> (Age: <?php echo $b['age']; ?> |
                    ...
                    <div class="space-y-2">
                        <div>
                            <label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Bride Name
                                *</label>
                            <input type="text" id="bride_name_field" name="bride_name" required placeholder="Bride Name"
                                class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-xs focus:ring-1 focus:ring-teal-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Father's Name
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                <label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Bride Age
                                    *</label>
                                <input type="number" id="bride_age_field" name="bride_age" required min="18"
                                    placeholder="Age"
                                    class="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-xs focus:ring-1 focus:ring-teal-500 focus:outline-none">
                ...
                <div class="flex items-center h-full pt-4">
                    <label class="flex items-center gap-2 cursor-pointer text-xs text-slate-700 font-bold select-none">
                        <input type="checkbox" id="nikah-conducted-check" name="conducted_by_jamath" value="1" checked
                            class="h-4 w-4 text-teal-600 focus:ring-teal-500 rounded border-slate-300"> Fully Conducted
                        by NVK Jamaath
                    </label>
                </div>
            </div>
            ...
            <div class="flex items-center space-x-2 pt-4 border-t border-slate-100">
                ...
                <button type="submit" id="nikah-form-submit"
                    class="w-1/2 bg-teal-700 hover:bg-teal-800 text-white py-3 rounded-xl font-bold shadow-md transition-colors">
